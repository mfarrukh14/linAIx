 ...
 * and BIOS loaders. If you want to tweak linAIxOS's bootloader
...
/* Basic text strings */
#define BASE_VERSION "linAIxOS Bootloader v5.0"
...
char * COPYRIGHT_TEXT = "linAIxOS is free software under the NCSA license.";
char * LINK_TEXT = "https://linAIxos.org - https://github.com/klange/linAIxos";
