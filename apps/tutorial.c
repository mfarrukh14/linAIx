 ...
 *        the functionality of linAIxOS and how to use the WM.
 *
 * @copyright
...
static char * randomly_select_begging(void) {
	char * options[] = {
		"You can help support linAIxOS by donating:",
		"Your donation helps us continue developing linAIxOS:",
		"You can sponsor linAIxOS development on Github:",
...
static void load_page(int page) {
	...
	switch (page) {
		case 0:
			_prev_enabled = 0;
			title_str = "Welcome to linAIxOS!";
			icon = &logo;
			body_text[i++] = "#Welcome to linAIxOS!";
			body_text[i++] = "";
			...
			body_text[i++] = "";
			body_text[i++] = "%https://github.com/klange/linAIxos - https://linAIxos.org";
			body_text[i++] = "";
			body_text[i++] = "linAIxOS is free software, released under the terms of the";
		...
		case 1:
			icon = &logo;
			body_text[i++] = "linAIxOS is a hobby project. The entire contents of this Live CD";
			body_text[i++] = "were written by the linAIxOS development team over the course of";
			...
			body_text[i++] = "through IRC by joining the #linAIxos channel on Libera.chat.";
			body_text[i++] = "";
			body_text[i++] = "You can help support linAIxOS by donating:";
			body_text[i++] = "%https://github.com/sponsors/klange";
			body_text[i++] = NULL;
			break;
		case 2:
		...
		case 4:
			icon = &terminal;
			circle(70, 170, 60);
			body_text[i++] = "linAIxOS aims to provide a Unix-like environment. You can find";
			body_text[i++] = "familiar command-line tools by opening a terminal. linAIxOS's";
		...
		case 5:
			icon = &package;
			circle(70, 250, 60);
			body_text[i++] = "Many third-party software packages have been ported to linAIxOS";
		...
		case 6:
			icon = &mouse_drag;
			body_text[i++] = "With linAIxOS's window manager, you can drag most windows by";
			...
			body_text[i++] = "";
			body_text[i++] = "Note that if you are running linAIxOS in a virtual machine, your";
			body_text[i++] = "host operating system configuration may conflict with modifier";
			body_text[i++] = "keys in linAIxOS.";
			body_text[i++] = NULL;
			break;
		case 7:
			icon = NULL;
			...
			body_text[i++] = "";
			body_text[i++] = "Press \"Exit\" to close this window and start exploring linAIxOS.";
			body_text[i++] = NULL;
			break;
		default:
			exit(0);
