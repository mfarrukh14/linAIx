...
void handle_input(char * buf) {
	...
	if (strstr(buf, "/help") == buf) {
		...
		fprintf(sock_w, "QUIT :%s\r\n", m ? m : "https://github.com/klange/linAIxos");
		fflush(sock_w);
...
int main(int argc, char * argv[]) {
	...
	fprintf(stdout, " - linAIx IRC v %s - \n", VERSION_STRING);
	fprintf(stdout, " Copyright 2015-2018 K. Lange\n");
	fprintf(stdout, " https://linAIxos.org - https://github.com/klange/linAIxos\n");
	fprintf(stdout, " \n");
