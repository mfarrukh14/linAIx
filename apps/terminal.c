...
static void _menu_action_show_about(struct MenuEntry * self) {
	...
	strcat(about_cmd, "about \"About Terminal\" /usr/share/icons/48/utilities-terminal.png \"linAIxOS Terminal\" \"© 2013-2026 K. Lange\n-\nPart of linAIxOS, which is free software\nreleased under the NCSA/University of Illinois\nlicense.\n-\n%https://linAIxos.org\n%https://github.com/klange/linAIxos\" ");
	char coords[100];
