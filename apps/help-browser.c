 ...
 * from mainline linAIxOS. It is currently incomplete.
 *
...
static void _menu_action_about(struct MenuEntry * entry) {
	...
	strcat(about_cmd, "about \"About Help Browser\" /usr/share/icons/48/help.png \"linAIxOS Help Browser\" \"© 2018-2020 K. Lange\n-\nPart of linAIxOS, which is free software\nreleased under the NCSA/University of Illinois\nlicense.\n-\n%https://linAIxos.org\n%https://github.com/klange/linAIxos\" ");
	char coords[100];
