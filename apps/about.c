 ...
 *
 * By default, shows "About linAIxOS", suitable for use as an application
...
static void init_default(void) {
...

	{
		...
		sprintf(version_str, "linAIxOS %s", u.release);
	}

	copyright_str[0] = "© 2011-2026 K. Lange, et al.";
	copyright_str[1] = "-";
	copyright_str[2] = "linAIxOS is free software released under the";
	copyright_str[3] = "NCSA/University of Illinois license.";
	copyright_str[4] = "-";
	copyright_str[5] = "%https://linAIxos.org";
	copyright_str[6] = "%https://github.com/klange/linAIxos";
}
